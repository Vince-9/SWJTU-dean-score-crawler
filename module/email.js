...
exports.sendMailSuccessLogin = function (email, grades) {
    ...
    let mailOptions = {
        ...
        html: `<h1>欢迎来到麦芽糖的邮件通知系统</h1><h2>当有新成绩时，我会第一时间通知你哒</h2><p>最新成绩为：</p><p>${grades.className}</p><p>最终成绩：<b>${grades.finalGrade}</b></p><p>期末成绩：<b>${grades.paperGrade}</b></p><p>平时成绩：<b>${grades.regularGrade}</b></p>` // html body
    };
...
exports.sendMailSuccessLoginWithoutComment = function (email) {
    ...
    let mailOptions = {
        ...
        to: email, // list of receivers
        subject: '【登录成功】你已成功登录成绩通知系统', // Subject line
        html: `<h1>欢迎来到麦芽糖的邮件通知系统</h1><h2>当有新成绩时，我会第一时间通知你哒</h2><h2>你还没有完成课程评价，我无法查询你的成绩哦</h2>` // html body
    };
